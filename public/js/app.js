...
new Login();
new _home_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
new _home_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
var input = document.querySelector('.twan');
...
input.addEventListener('keyup', function () {
  ...
  axios.get('/brands/results/' + query).then(function (response) {
    // handle success
    console.log(response);
    response.data.forEach(function (item) {
      var itemContent = template.innerHTML.replace('{{ name }}', item.name).replace('{{ image }}', item.image);
  ...
  _createClass(Nav, [{
    ...
    value: function nav() {
      ...
      if (window.innerWidth < 1024) {
        ...
        var btn = document.querySelector('header .nav-toggle');
...
__webpack_require__(/*! C:\xampp74\htdocs\carproject.test\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp74\htdocs\carproject.test\resources\sass\app.scss */"./resources/sass/app.scss");

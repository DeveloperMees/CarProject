...
@section('scripts')
    ...
    <script>
        function actionsFormatter(value, row, index) {
            url = {
                edit: "{{ route('admin.cars.edit', ['id' => 'id']) }}",
                destroy: "{{ route('admin.cars.destroy', ['id' => 'id']) }}",
